<%-- 
    ...
    Created on : 21 Nov, 2014, 9:17:59 AM
    Author     : Admin
--%>
...
th, td {
    ...
    <center><h1><font color="purple" >Change Your Details</font></center>
  ...
  <nav class="vertical">
    ...
    <tr bgcolor="purple">
     <td align=“middle”>REQUEST CHANGE</td>

     </tr> 
    </table>
                    <br>
                    <div>
                        <label>Enter the detail to be changed</label>&nbsp;&nbsp;&nbsp;&nbsp;
                        <select name="old">
				
				<option value="name">Name</option>
				<option value="gender">Gender</option>
                                <option value="email">Email</option>
				<option value="dob">Gender</option>
