<%-- 
    Document   : addprofile
    Created on : 21 Nov, 2014, 11:14:33 AM
    Author     : Admin
--%>
...
th, td {
    ...
    <center><h1><font color="purple" >Student Profile</font></center>
  ...
  <nav class="vertical">
    <ul>
      ...
      <li>
       ...
       <div class="wrapper"  style="margin:10px">
            <form name="myform" action="addprofile" method="get" >  
     
    <table  border="2" bgcolor="white" width="100%" cellspacing="1" cellpadding="3">
   
    <tr bgcolor="purple">
     <td align=“middle”>Add Student Details</td>

     </tr>
    
    </table>
                <br>
            <label>REGISTRATION NUMBER</label><br><input type="text"  name = "regno">
                <br><br><br>
            <label>NAME</label><br><input type="text"  name = "name">
                <br><br><br>
                 <label>GENDER</label><br><input type="text" name = "gender">
                <br><br><br>
                 <label>EMAIL ID</label><br><input type="text" name = "email">
                <br><br><br>
                 <label>DATE OF BIRTH</label><br><input type="text" name = "dob">
                <br><br><br>
                 <label>PHONE NUMBER</label><br><input type="text" name = "phoneno">
                <br><br><br>
