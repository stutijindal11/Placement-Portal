<%-- 
    Document   : Resume
    Created on : 21 Nov, 2014, 10:43:41 AM
    Author     : Admin
--%>
...
th, td {
    ...
    <center><h1><font color="purple">Resume</font></center>
  ...
  <nav class="vertical">
    ...
    <tr bgcolor="purple">
     <td align=“middle”>RESUME FORMAT</td>

     </tr> 
    </table>
                    <br>
                    <div>
                       <label>Sample format for student referral.</label>
                       <br>					
			<a href="http://172.16.61.204/placement2014/help_files/Sample.docx" target="_blank">DOWNLOAD</a>
