<%-- 
    Document   : Details
    Created on : 21 Nov, 2014, 7:45:53 AM
    Author     : Admin
--%>
...
th, td {
    ...
    <center><h1><font color="purple" >My Details</font></center>
  ...
  <nav class="vertical">
   ...
   <div class="wrapper" style="margin:10px">
    ...
    <tr bgcolor="purple">
     <td align=“middle”>PERSONAL DETAILS</td>
     ...
     <%
           Connection conn;
            ...
            while(rs.next()){
            %>
            <label>REGISTRATION NUMBER</label><br><%= rs.getString(1) %>
                <br><br><br>
            <label>NAME</label><br><%= rs.getString(2) %>
                <br><br><br>
                 <label>GENDER</label><br><%= rs.getString(3) %>
                <br><br><br>
                 <label>EMAIL ID</label><br><%= rs.getString(4) %>
                <br><br><br>
                 <label>DATE OF BIRTH</label><br><%= rs.getString(5) %>
                <br><br><br>
                 <label>PHONE NUMBER</label><br><%= rs.getString(6) %>
                <br><br><br>
                 <label>CGPA</label><br><%= rs.getString(7) %>
                <br>
...
<div style="padding-top:600px;padding-left:370px;margin:10px">
